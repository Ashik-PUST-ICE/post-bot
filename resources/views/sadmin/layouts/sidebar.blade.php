            ...
            <ul class="zSidebar-menu" id="sidebarMenu">
                ...
                <li>
                    <a href="{{ route('super-admin.leads.index') }}"
                        class="d-flex align-items-center cg-21 {{ $activeLeads ?? '' }}">
                        <div class="d-flex">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                                fill="none">
                                <path
                                    ...
                                    stroke="#7881A4" stroke-width="1.2" />
                                <path
                                    d="M3.04688 16.5C3.04688 13.3244 5.57435 10.75 9 10.75C12.4257 10.75 14.9531 13.3244 14.9531 16.5"
                                    stroke="#7881A4" stroke-width="1.2" stroke-linecap="round" />
                            </svg>
                        </div>
                ...
                <li>
                    <a href="{{ route('super-admin.contact-us.index') }}"
                        class="d-flex align-items-center cg-21 {{ $activeContactUs ?? '' }}">
                        <div class="d-flex">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                                fill="none">
                                <path d="M3 4.5H15V13.5H3V4.5Z" stroke="#7881A4" stroke-width="1.2"
                                    stroke-linejoin="round" />
                                <path d="M3 6L9 9.75L15 6" stroke="#7881A4" stroke-width="1.2" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                        </div>
                ...
                <li>
                    <a href="{{ route('super-admin.setting.frontend-setting.index') }}"
                        class="d-flex align-items-center cg-21 {{ $activeFrontendList ?? '' }}">
                        <div class="d-flex {{ isset($activeFrontendList) ? 'active' : 'collapsed' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                                fill="none">
                                <path
                                    d="M17.125 14.625H16.5V9.01953C16.5 7.97461 15.6589 7.125 14.625 7.125H14V5.875C14 5.52954 13.7205 5.25 13.375 5.25H12.4235C12.3575 5.06384 12.2825 4.88196 12.1976 4.70435L12.8702 4.03113C13.1144 3.78699 13.1144 3.39148 12.8702 3.14734L11.1027 1.37976C10.8585 1.13562 10.463 1.13562 10.2189 1.37976L9.54596 2.05298C9.36835 1.96814 9.18585 1.89246 9 1.82654V0.875C9 0.529541 8.72015 0.25 8.375 0.25H5.875C5.52985 0.25 5.25 0.529541 5.25 0.875V1.82654C5.06415 1.89246 4.88196 1.96814 4.70435 2.05237L4.03143 1.37976C3.91425 1.26257 3.75525 1.19666 3.58954 1.19666C3.42383 1.19666 3.26483 1.26257 3.14764 1.37976L1.37976 3.14734C1.13562 3.39148 1.13562 3.78699 1.37976 4.03113L2.05237 4.70435C1.96783 4.88196 1.89246 5.06384 1.82654 5.25H0.875C0.529846 5.25 0.25 5.52954 0.25 5.875V8.375C0.25 8.72046 0.529846 9 0.875 9H1.82654C1.89246 9.18616 1.96783 9.36804 2.05237 9.54565L1.37976 10.2189C1.13562 10.463 1.13562 10.8585 1.37976 11.1027L3.14764 12.8702C3.21402 12.9366 3.2923 12.9813 3.375 13.0116V14.625H2.75C2.40485 14.625 2.125 14.9045 2.125 15.25C2.125 16.6288 3.24652 17.75 4.625 17.75H15.25C16.6288 17.75 17.75 16.6288 17.75 15.25C17.75 14.9045 17.4705 14.625 17.125 14.625ZM2.28888 7.75H1.5V6.5H2.28888C2.57391 6.5 2.82294 6.30713 2.89404 6.03125C2.99658 5.63452 3.15283 5.2561 3.35913 4.90698C3.50439 4.66162 3.46472 4.34851 3.263 4.14709L2.70544 3.58923L3.58954 2.70544L4.14709 3.26331C4.34851 3.46472 4.66132 3.50378 4.90668 3.35974C5.25671 3.15283 5.63513 2.99597 6.03156 2.89343C6.30743 2.82202 6.5 2.57361 6.5 2.28857V1.5H7.75V2.28857C7.75 2.57361 7.94257 2.82202 8.21844 2.89343C8.61487 2.99597 8.99329 3.15283 9.34332 3.35974C9.58899 3.50439 9.90149 3.46472 10.1029 3.26331L10.6608 2.70544L11.5446 3.58923L10.9867 4.14709C10.7853 4.34851 10.7456 4.66162 10.8903 4.90698C11.0972 5.25671 11.254 5.63513 11.3566 6.03125C11.428 6.30713 11.6764 6.5 11.9614 6.5H12.75V7.125H10.25C10.25 5.40198 8.84802 4 7.125 4C5.40198 4 4 5.40198 4 7.125C4 7.27526 4.01358 7.42449 4.03479 7.57239C3.63223 7.91369 3.375 8.41879 3.375 9V9.38425C3.36832 9.37086 3.36684 9.35606 3.35913 9.34302C3.15283 8.9939 2.99658 8.61548 2.89404 8.21875C2.82294 7.94287 2.57391 7.75 2.28888 7.75ZM5.25 7.125C5.25 6.09106 6.09106 5.25 7.125 5.25C8.15894 5.25 9 6.09106 9 7.125H5.25ZM2.70544 10.6608L3.263 10.1029C3.30984 10.0561 3.34589 10.0023 3.375 9.94566V11.3302L2.70544 10.6608ZM4.625 9C4.625 8.64355 4.89355 8.375 5.25 8.375H14.625C14.9753 8.375 15.25 8.6582 15.25 9.01953V14.625H4.625V9ZM15.25 16.5H4.625C4.16327 16.5 3.75922 16.2485 3.54285 15.875H16.3322C16.1161 16.2485 15.712 16.5 15.25 16.5Z"
                                    fill="#7881A4" />
                                <path
                                    d="M8.19189 9.80811C7.94775 9.56396 7.55225 9.56396 7.30811 9.80811L6.05811 11.0581C5.81396 11.3022 5.81396 11.6978 6.05811 11.9419L7.30811 13.1919C7.43018 13.314 7.59009 13.375 7.75 13.375C7.90991 13.375 8.06982 13.314 8.19189 13.1919C8.43604 12.9478 8.43604 12.5522 8.19189 12.3081L7.38379 11.5L8.19189 10.6919C8.43604 10.4478 8.43604 10.0522 8.19189 9.80811Z"
                                    fill="#7881A4" />
                                <path
                                    d="M10.4014 9.64414C10.0669 9.55808 9.72696 9.76316 9.64396 10.0989L9.01865 12.5989C8.93503 12.9333 9.13859 13.2727 9.47336 13.3563C9.52433 13.3691 9.57529 13.3752 9.62565 13.3752C9.9058 13.3752 10.1603 13.186 10.2311 12.9016L10.8561 10.4016C10.9403 10.0671 10.7365 9.72776 10.4014 9.64414Z"
                                    fill="#7881A4" />
                                <path
                                    d="M12.5669 9.80811C12.3228 9.56396 11.9272 9.56396 11.6831 9.80811C11.439 10.0522 11.439 10.4478 11.6831 10.6919L12.4912 11.5L11.6831 12.3081C11.439 12.5522 11.439 12.9478 11.6831 13.1919C11.8052 13.314 11.9651 13.375 12.125 13.375C12.2849 13.375 12.4448 13.314 12.5669 13.1919L13.8169 11.9419C14.061 11.6978 14.061 11.3022 13.8169 11.0581L12.5669 9.80811Z"
                                    fill="#7881A4" />
                            </svg>
                        </div>
