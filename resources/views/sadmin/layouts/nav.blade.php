        ...
        <div class="d-flex align-items-center cg-12">
                        ...
                        @foreach (appLanguages() as $app_lang)
                            <li>
                                <a class="d-flex align-items-center cg-8"
                                   href="{{ url('/super-admin/local/' . $app_lang->iso_code) }}">
            ...
            <div class="dropdown notifyDropdown">
                ...
                <div class="dropdown-menu">
                    <div class="d-flex justify-content-between align-items-center bd-c-light-border bd-b-one pb-8 mb-8">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        @else
                                            <p class="fs-13 fw-500 lh-20 text-textBlack">{{$item->title}}</p>
                                        @endif
                                        <p class="fs-10 fw-400 lh-20 text-para-tex">
                                    ...
                                    @if($item->seen_id == null)
                                        <p class="fs-12 fw-400 lh-17 text-para-text max-w-220">
                                            <a href="{{route('super-admin.notification.view',$item->id)}}"
                                               class="text-textBlack text-decoration-underline hover-color-main-color">{{__('See More')}}</a>
                                        </p>
                                    @else
                                        <p class="fs-12 fw-400 lh-17 text-para-text max-w-220">
                                            <a href="{{route('super-admin.notification.view',$item->id)}}"
