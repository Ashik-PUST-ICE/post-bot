                            ...
                            <div class="row">
                                @foreach(appLanguages() as $lan)
                                    @php
                                        ...
                                        $policy = $privacy_policy->firstWhere('option_key', 'privacy_policy_' . $lan->iso_code);
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary-form-group">
                                            ...
                                            <div class="primary-form-group-wrap">
                                                <textarea class="summernoteOne" name="privacy_policy_{{ $lan->iso_code }}" placeholder="Body" style="height: 800px;">{!! $policyContent !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
