...
<div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
    <div class="">
        <h4 class="fs-18 fw-400 lh-18 text-textBlack pb-16">{{ __($title) }}</h4>
        <div class="row rg-20">
            <div class="col-xl-3">
            ...
            <div class="col-xl-9">
                    <h4 class="fs-18 fw-400 lh-18 text-textBlack pb-16">{{ $title }}</h4>
                <div class="bg-white p-sm-25 p-15 bd-one bd-c-stroke bd-ra-8">
                    <div class="pb-20">
                        ...
                        <div class="">
                            <a href="{{ route('super-admin.setting.storage.link') }}"
                                class="d-inline-block py-12 pr-15 pl-10 bd-one bd-c-main-color bg-main-color bd-ra-4 fs-14 fw-500 lh-14 text-white">
                                {{ __('Storage Link') }}</a>
                        </div>
                    </div>
