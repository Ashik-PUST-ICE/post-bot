                            ...
                            <div class="row">
                                @foreach(appLanguages() as $lan)
                                    @php
                                        ...
                                        $policy = $return_policy->firstWhere('option_key', 'return_policy_' . $lan->iso_code);
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary-form-group">
                                            ...
                                            <div class="primary-form-group-wrap">
                                                <textarea class="summernoteOne" name="return_policy_{{ $lan->iso_code }}" placeholder="Body" style="height: 800px;">{!! $policyContent !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
