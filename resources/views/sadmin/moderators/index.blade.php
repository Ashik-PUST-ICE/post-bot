...
@section('content')
    ...
    <div class="modal fade" id="addModeratorModal" tabindex="-1" aria-labelledby="addModeratorModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content border-0 bd-ra-4 p-20">
                ...
                <form class="ajax reset" action="{{route('super-admin.staff.store')}}" method="POST" enctype="multipart/form-data" data-handler="commonResponse">
                    @csrf
    ...
    <input type="hidden" id="moderatorTableRoute" value="{{route('super-admin.staff.index')}}">
@endsection
