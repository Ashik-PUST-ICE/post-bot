                        ...
                        <table class="table">
                            <tbody class="align-baseline">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="251px">
                                                                    <div id="actions">
                                                                        ...
                                                                        <a data-url="{{ route('admin.version-update-execute') }}"
                                ...
                                <tr>
                                    <td>
                                        {{ $uploadedFile }}
                                        <a data-url="{{ route('admin.version-delete') }}" data-reload="true"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 border rounded p-3 mt-5">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xs-2 col-lg-6 pt-2">
...
<script>
    var previewNode = document.querySelector("#template");
        ...
        var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
            url: "{{ route('admin.version-update-store') }}", // Set the url
            method: 'post',
            headers: {
