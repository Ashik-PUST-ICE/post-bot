                            ...
                            <tr>
                                ...
                                <td>
                                    @if($user->status == STATUS_ACTIVE)
                                        <span class="status-btn status-btn-green">{{ __('Active') }}</span>
                                    @else
                                        <span class="status-btn status-btn-red">{{ __('Inactive') }}</span>
                                    @endif
                                </td>
                                ...
                                <td>
                                    <ul class="d-flex align-items-center cg-5 justify-content-center">
                                        <li class="d-flex gap-2">
                                            <button onclick="getEditModal('{{route('admin.users.edit', $user->id)}}', '#edit-modal')"
                                            ...
                                            <button onclick="deleteItem('{{ route('admin.users.destroy', [$user->id]) }}')"
                                                    class="d-flex justify-content-center align-items-center w-30 h-30 rounded-circle bd-one bd-c-ededed bg-white"
                                                    title="{{__('Delete')}}">
                ...
                <form class="ajax reset" action="{{ route('admin.users.store') }}" method="post"
                    ...
                    <div class="modal-body zModalTwo-body model-lg">
                        <div class="d-flex justify-content-between align-items-center pb-30">
                            <h4 class="fs-20 fw-500 lh-38 text-1b1c17">{{__('Add New User')}}</h4>
                            <div class="mClose">
                        ...
                        <div class="row rg-25">
                            ...
                            <div class="col-md-6">
                                <div class="primary-form-group">
                                    <div class="primary-form-group-wrap">
                                        <label for="Status" class="form-label">{{ __('Assign Role') }} <span
                                                class="text-danger">*</span></label>
                                        <select class="primary-form-control sf-select-without-search" id="roles"
                                                name="roles[]" multiple>
