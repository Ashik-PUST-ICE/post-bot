...
@section('content')
    <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap g-10 pb-26">
            <div>
                <h4 class="fs-24 fw-600 lh-29 text-textBlack">{{ __('Analytics') }}</h4>
                <p class="fs-14 fw-400 text-para-text mt-5">{{ __('Performance overview of your AI agent and conversations.') }}</p>
            </div>
        </div>
