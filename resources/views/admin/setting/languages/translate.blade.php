        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 bd-ra-4 p-10">
                <form class="ajax" action="{{ route('admin.setting.languages.import') }}" method="POST"
                    ...
                    <div
                        class="d-flex justify-content-between align-items-center bd-b-one bd-c-light-border pb-20 mb-20">
                        <h5 class="fs-18 fw-600 lh-18 text-textBlack">{{ __('Import Language') }}</h5>
                    ...
                    <div class="bd-t-one bd-c-light-border pt-17 d-flex g-10">
                        <button type="button"
                                ...
                                data-bs-dismiss="modal" title="Back">{{
                        __('Back')
                        }}</button>
                        <button type="submit"
