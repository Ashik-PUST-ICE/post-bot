...
@section('content')
    ...
    <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
        ...
        <div class="d-flex justify-content-lg-end">
            <a title="{{__('Sync missing gateway')}}" href="{{ route('admin.setting.gateway.syncs') }}" class="py-12 pr-15 pl-13 bd-one bg-main-color bd-ra-4 fs-14 text-white" onclick="return confirm('Are you sure you want to sync gateways?');">
                <i class="fa fa-sync-alt"></i>
            </a>
        </div>
        <div class="bd-one bd-c-light-border bd-ra-8 bg-white p-sm-25 p-15 mt-20">
