                    ...
                    <div class="pb-20">
                        ...
                        <div class="">
                            <a href="{{ route('admin.setting.storage.link') }}"
                               class="d-inline-block py-13 px-20 bd-one bd-ra-4 bd-c-main-color bg-main-color text-white fs-14 fw-600 lh-14 d-inline-block">
                                {{ __('Storage Link') }}</a>
                        </div>
                    </div>
                            ...
                            <div class="form-group row">
                                <div class="primary-form-group">
                                    <div class="primary-form-group-wrap">
                                        <label for="STORAGE_DRIVER" class="zForm-label">{{ __('Storage Driver')
                                        }}</label>
