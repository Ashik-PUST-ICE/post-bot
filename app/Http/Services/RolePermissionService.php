                ...
                if ($data->id == 1) {
                    return '<div class="dropdown dropdown-one">
                           ...
                           <ul class="dropdown-menu dropdownItem-one">
                              <li>
                                 <button  data-bs-toggle="modal" data-bs-target="#addPermissionModal" class="d-flex align-items-center cg-8 border-0 bg-transparent" onclick="getEditModal(\'' . route('admin.role-permission.permission', encrypt($data->id)) . '\'' . ', \'#addPermissionModal\')">
                                    <div class="d-flex">
                    ...
                    return '<div class="dropdown dropdown-one">
                           ...
                           <ul class="dropdown-menu dropdownItem-one">
                              ...
                              <li>
                                 <button class="d-flex align-items-center cg-8 border-0 bg-transparent" onclick="getEditModal(\'' . route('admin.role-permission.edit', encrypt($data->id)) . '\'' . ', \'#editRoleModal\')">
                                    <div class="d-flex">
                              ...
                              <li>
                                 <button class="d-flex align-items-center cg-8 border-0 bg-transparent deleteItem" onclick="deleteItem(\'' . route('admin.role-permission.delete', encrypt($data->id)) . '\', \'rolePremissionListTable\')">
